...
class B2DebugDraw 
{
	...
	*/
	...
	#if js
	public function setSprite(sprite : B2DebugSprite) {
		m_sprite = sprite;
	}
	...
	* Get the sprite
	*/
	public function getSprite() : B2DebugSprite {
		return m_sprite;
	}
	#end
	...
	*/
	...
	//trace("drawPolygon");	
		...
		#elseif js
		m_sprite.drawPolygon(vertices, vertexCount, color, m_drawScale);
		#end
	...
	*/
	...
	//trace("drawSolidPolygon");	
		...
		#elseif js
		m_sprite.drawSolidPolygon(vertices, vertexCount, color, m_drawScale);
		#end
	}
	...
	*/
	public function drawCircle(center:B2Vec2, radius:Float, color:B2Color) : Void {
		...
		m_sprite.drawCircle(center, radius, color, m_drawScale);
		#end
	}
	...
	*/
	...
	//trace("drawSolidCircle");	
		...
		#elseif js
		m_sprite.drawSolidCircle(center, radius, axis, color, m_drawScale);
		#end
	}
	...
	*/
	...
	//trace("Segment");	
		...
		#elseif js
		m_sprite.drawSegment(p1, p2, color, m_drawScale);
		#end
	}
	...
	*/
	...
	//trace("drawTransform");	
		...
		#elseif js
		m_sprite.drawTransform(xf, m_drawScale);
		#end
	}
	...
	#elseif js
	public var m_sprite : B2DebugSprite;
	#end
